    ...
    <div class="row w-100 justify-content-end">
        <div class="col-lg-6 col-sm-12 ">
            <form class="g-3 needs-validation w-100 p-5 text-center bg-gradient " action="process.php" method="post" novalidate>
                ...
                <?php if (isset( $_SESSION['no-such-record'])) : ?>
                    <div class="alert alert-danger alert-dismissible fade show d-flex" role="alert">
                        <strong>Login Failed ! &nbsp; &nbsp;</strong>
                        <div><?php echo  $_SESSION['no-such-record']; unset($_SESSION['no-such-record']) ?></div>
                ...
                <div class="mb-3 text-start">
                    ...
                    <div class="input-group has-validation">
                        ...
                        <input type="email" class="form-control bg-transparent text-light fs-14px" id="validationCustomUsername" aria-describedby="inputGroupPrepend" name="email" value='<?php echo (isset($_SESSION['register-info'])) ? $_SESSION['register-info'][0]  :'' ?>' required>
                ...
                <div class="mb-3 text-start">
                    ...
                    <div class="input-group has-validation">
                        ...
                        <input type="password" class="form-control bg-transparent text-light fs-14px" id="validationCustomUsername" aria-describedby="inputGroupPrepend" name="pwd" value='<?php echo (isset($_SESSION['register-info'])) ? $_SESSION['register-info'][1]  :'' ?>' required>
                        <div class="invalid-feedback">
                ...
                <div class="col-12">
                    <button class="btn  w-100" style="background-color: #39cb78" name="signin-btn" type="submit">Sign in</button>
                </div>
                <div class="col-12 mt-3">
                    <a href="signup.php" class="link-white ">Create an account account </a>
                </div>
            </form>
        </div>
    </div>
